    ...
    funcao inicio()
    {
        ...
        faca
        {
            ...
            se (logado == verdadeiro e tiposUsuarios[usuarioLogado] == "GESTOR")
            {
                ...
                escreva("║ 16 - Atualizar status de curriculo           ║\n")
                escreva("║ 17 - Listar usuarios cadastrados             ║\n")
            }
            ...
            escolha(opcao)
            {
                ...
                caso 16:
                    limpa()
                    escreva("=== ATUALIZAR STATUS DE CURRICULO ===\n\n")

                    se (logado == falso ou (tiposUsuarios[usuarioLogado] != "GESTOR" e tiposUsuarios[usuarioLogado] != "EMPRESA"))
                    {
                        escreva("Apenas GESTOR ou EMPRESA podem atualizar curriculos.\n")
                    }
                    senao se (qtdCurriculos == 0)
                    {
                        escreva("Nenhum curriculo cadastrado.\n")
                    }
                    senao
                    {
                        para (i = 0; i < qtdCurriculos; i++)
                        {
                            ...
                            escreva("Email: ", emailCandidato[i], "\n")
                            escreva("Vaga: ", vagaCandidato[i], "\n")
                            escreva("Status atual: ", statusCandidato[i], "\n\n")
                        }

                        escreva("Digite o indice do curriculo para atualizar: ")
                        leia(indice)

                        se (indice < 0 ou indice >= qtdCurriculos)
                        {
                            escreva("Indice invalido.\n")
                        }
                        senao
                        {
                            inteiro escolhaStatusCurriculo
                            escreva("\n1 - ENVIADO\n")
                            escreva("2 - EM_ANALISE\n")
                            escreva("3 - APROVADO\n")
                            escreva("4 - REPROVADO\n")
                            escreva("Escolha o novo status: ")
                            leia(escolhaStatusCurriculo)

                            se (escolhaStatusCurriculo == 1)
                            {
                                novoStatus = "ENVIADO"
                            }
                            senao se (escolhaStatusCurriculo == 2)
                            {
                                novoStatus = "EM_ANALISE"
                            }
                            senao se (escolhaStatusCurriculo == 3)
                            {
                                novoStatus = "APROVADO"
                            }
                            senao se (escolhaStatusCurriculo == 4)
                            {
                                novoStatus = "REPROVADO"
                            }
                            senao
                            {
                                novoStatus = statusCandidato[indice]
                            }

                            statusCandidato[indice] = novoStatus
                            escreva("\nStatus do curriculo atualizado para ", novoStatus, ".\n")
                        }
                    }
                ...
                caso 17:
                    limpa()
                    escreva("=== LISTAR USUARIOS CADASTRADOS ===\n\n")

                    se (logado == falso ou tiposUsuarios[usuarioLogado] != "GESTOR")
                    {
                        escreva("Apenas usuarios do tipo GESTOR podem acessar esta funcao.\n")
                    }
                    senao se (qtdUsuarios == 0)
                    {
                        escreva("Nenhum usuario cadastrado.\n")
                    }
                    senao
                    {
                        para (i = 0; i < qtdUsuarios; i++)
                        {
                            ...
                            escreva("Nome: ", nomesUsuarios[i], "\n")
                            escreva("Email: ", emailsUsuarios[i], "\n")
                            escreva("Tipo: ", tiposUsuarios[i], "\n")

                            se (tentativas[i] >= 3)
                            {
                                escreva("Status: BLOQUEADO\n\n")
                            }
                            senao
                            {
